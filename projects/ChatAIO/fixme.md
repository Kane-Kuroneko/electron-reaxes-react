...
ChatAIO 支持多个同 family 的 AI 页面实例，例如两个 ChatGPT 页面使用不同 URL、不同 proxy 或不同登录账号。预加载策略如果只返回 family，会把这些实例折叠成一个类型。
...
- `projects/ChatAIO/src/Main/services/settings/ai-config-service.ts`
- `projects/ChatAIO/src/Types/IpcSchema.d.ts`
- `projects/ChatAIO/src/preload.ts`
- `projects/ChatAIO/src/Views/SettingsView/services/Settings/index.ts`
- `projects/ChatAIO/src/Views/SettingsView/reaxels/settings-view/index.ts`
