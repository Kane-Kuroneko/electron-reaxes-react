...
| 文档 | 内容 |
|------|------|
| [ai-config.md](./docs/architecture/ai-config.md) | AI 配置双层（用户项 / 运行时 view）；目标模型见下方提案 |
...
| [feature-proposal--ai-catalog-source.md](./docs/feature-proposal--ai-catalog-source.md) | AI 目录单一事实源（分批执行） |
