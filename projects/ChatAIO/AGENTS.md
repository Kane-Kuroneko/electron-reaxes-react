...
- [AI 配置（供应商目录 / 用户页实例）](./docs/architecture/ai-config.md)
- [目录单一事实源落地记录](./docs/feature-proposal--ai-catalog-source.md)
...
| 文档 | 内容 |
|------|------|
| [ai-config.md](./docs/architecture/ai-config.md) | 供应商目录 / 用户页实例（现行） |
