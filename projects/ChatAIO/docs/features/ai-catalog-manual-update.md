...
- 三层模型和 merge 规则：[`../architecture/ai-config.md`](../architecture/ai-config.md)
- 分批落地记录与已否决项：[`../feature-proposal--ai-catalog-source.md`](../feature-proposal--ai-catalog-source.md)
