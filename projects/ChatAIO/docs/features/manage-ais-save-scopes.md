...
| Settings DOM | 页脚 vs 表底、弹窗 Save/Cancel、Undo/Discard、Startup、目录挡板、Add / Clone（含空名用 placeholder）、待删除 | [`e2e/tests/settings-ais-save-scopes-ui.spec.ts`](../../e2e/tests/settings-ais-save-scopes-ui.spec.ts)、[`e2e/tests/settings-ais-pending-delete.spec.ts`](../../e2e/tests/settings-ais-pending-delete.spec.ts)、[`e2e/tests/settings-exit-without-save.spec.ts`](../../e2e/tests/settings-exit-without-save.spec.ts) |
