export default {
	...
	"Disable wheel zoom": "禁止滚轮缩放视角",
	"Replace F6 quick save with timestamped save": "替换F6快速保存为以时间戳命名的存档",
	"Enable Right Mouse Button Dragging": "开启鼠标右键拖拽屏幕",
	"Right-click detection delay": "右键检测延迟",
	"Activing": "改键生效中",
	"Enable": "开启改键",
	...
	"By donating, you agree to these terms": "若发生捐赠行为则默认您同意此条款",
	"View On Github": "在Github上查看本项目",
	"View Log": "查看日志",
