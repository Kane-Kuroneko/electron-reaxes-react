export default {
	...
	"Description" : "作用" ,
	"Drag to Sort" : "拖拽排序" ,
	"If you make a donation, it is assumed that you agree to these terms." : "若发生捐赠行为，则视为您同意上述条款。" ,
	"If you make a donation, it is assumed that you agree to the" : "若发生捐赠，则默认您同意" ,
	"These showing functions are not available until you download the app." : "提示：正在展示的魔兽助手开关没有实际作用,仅作展示。在下方下载安装后方可使用" ,
	"AliPay" : "支付宝" ,
	"WeChat Pay" : "微信支付" ,
	"PayPal" : "PayPal" ,
	"Choose a donation channel" : "选择一种捐赠渠道" ,
	"Copy email to clipboard successfully!" : "已复制邮箱到剪贴板！" ,
	"Failed to copy email to clipboard ,please copy it manually!" : "复制邮箱到剪贴板失败，请手动复制！" ,
