...
module.exports = {
	...
	options : {
		...
		// exclude : "node:|^fs$|^path$|^os$|^http$|^https$|^util$|^events$|^stream$|^child_process$|^crypto$|^net$|^tls$|^dns$|^url$|^querystring$|^zlib$|^buffer$|^vm$|^module$|^readline$",
		includeOnly: "^src/",
...
// generated: dependency-cruiser@16.8.0 on 2024-12-14T15:03:33.229Z
